...
abstract class AppLocalizations {
  ...
  /// No description provided for @modelSelectionRecommended.
  ///
  /// In en, this message translates to:
  /// **'Recommended'**
  String get modelSelectionRecommended;

  /// No description provided for @modelSelectionNoStarredModels.
  ///
  /// In en, this message translates to:
  /// **'Star a model to access it quickly here'**
  String get modelSelectionNoStarredModels;
  ...
  /// No description provided for @sessionErrorNotificationTitle.
  ///
  /// In en, this message translates to:
  /// **'Session error'**
  String get sessionErrorNotificationTitle;

  /// No description provided for @sessionErrorNotificationBodyWithTitle.
  ///
  /// In en, this message translates to:
  /// **'{title} encountered an error'**
  String sessionErrorNotificationBodyWithTitle(String title);

  /// No description provided for @sessionErrorNotificationBodyWithoutTitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @gitFilesTitle.
  ///
  /// In en, this message translates to:
  /// **'Git Files'**
  String get gitFilesTitle;

  /// No description provided for @gitFilesEmptyTitle.
  ///
  /// In en, this message translates to:
  /// **'No changes'**
  String get gitFilesEmptyTitle;

  /// No description provided for @gitFilesEmptySubtitle.
  ///
  /// In en, this message translates to:
  /// **'No file changes detected in the current project'**
  String get gitFilesEmptySubtitle;

  /// No description provided for @gitFilesLoadFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to load git file status'**
  String get gitFilesLoadFailed;

  /// No description provided for @gitFilesCount.
  ///
  /// In en, this message translates to:
  /// **'{count} files changed'**
  String gitFilesCount(int count);

  /// No description provided for @gitFilesStatusAdded.
  ///
  /// In en, this message translates to:
  /// **'added'**
  String get gitFilesStatusAdded;

  /// No description provided for @gitFilesStatusDeleted.
  ///
  /// In en, this message translates to:
  /// **'deleted'**
  String get gitFilesStatusDeleted;

  /// No description provided for @gitFilesStatusModified.
  ///
  /// In en, this message translates to:
  /// **'modified'**
  ...
  /// No description provided for @skillSelectionTitle.
  ///
  /// In en, this message translates to:
  /// **'Skills'**
  String get skillSelectionTitle;

  /// No description provided for @skillSelectionSearchHint.
  ///
  /// In en, this message translates to:
  /// **'Search skills'**
  String get skillSelectionSearchHint;

  /// No description provided for @skillSelectionNoSkills.
  ///
  /// In en, this message translates to:
  /// **'No skills available'**
  ...
  /// No description provided for @revertToHere.
  ///
  /// In en, this message translates to:
  /// **'Revert to here'**
  String get revertToHere;

  /// No description provided for @revertConfirmTitle.
  ///
  /// In en, this message translates to:
  /// **'Revert to here'**
  String get revertConfirmTitle;

  /// No description provided for @revertConfirmBody.
  ///
  /// In en, this message translates to:
  /// **'This will remove all messages after this point. Continue?'**
  String get revertConfirmBody;

  /// No description provided for @revertConfirmAction.
  ///
  /// In en, this message translates to:
  /// **'Revert'**
  String get revertConfirmAction;
  ...
  /// No description provided for @revertBannerText.
  ///
  /// In en, this message translates to:
  /// **'Reverted · Messages after this point are hidden'**
  String get revertBannerText;

  /// No description provided for @revertRestore.
  ///
  /// In en, this message translates to:
  /// **'Restore'**
  String get revertRestore;
  ...
  /// No description provided for @unrevertFailed.
  ///
  /// In en, this message translates to:
